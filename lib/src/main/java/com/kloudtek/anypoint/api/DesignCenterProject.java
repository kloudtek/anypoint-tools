...
public class DesignCenterProject extends AnypointObject<Organization> {
    ...
    public static DesignCenterProject create(Organization organization, String name, String type, boolean visualDesignerMode, String ownerId) throws HttpException {
        ...
        String json = client.getHttpHelper().httpPostWithOrgAndOwner("/designcenter/api-designer/projects", req, organization.getId(), ownerId);
    ...
    public DesignCenterProjectExchange getExchange(String branch) throws HttpException {
        String json = client.getHttpHelper().httpGet("/designcenter/api-designer/projects/" + id + "/branches/" + branch + "/exchange");
        return client.getJsonHelper().readJson(new DesignCenterProjectExchange(this),json);
    }

    public void publishExchange(String branch, String assetId, String name, String mainFile, String assetVersion, String apiVersion) {
